...
function progressive(val) {
    ...
    switch (true) {
        ...
        case val >= 10000 && val <= 100000:
            result += 5000 * 0.05 // dikenakan 0.05 = 5%
            result += 5000 * 0.1 // dikenakan 0.1 = 10%
            result += (val - 10000) * 0.15 // jika case range 5001 - 10000 maka value dikalikan 0.15 = 15%
            break
        case val >= 100000:
            result += 5000 * 0.05; // dikenakan 0.05 = 5%
            result += 5000 * 0.1; // dikenakan 0.1 = 10%
            result += 82000 * 0.15; // dikenakan 0.15 = 15%
            result += (val - 100000) * 0.2; // jika case range 5001 - 10000 maka value dikalikan 0.2 = 20%
            break
    }
